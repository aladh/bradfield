...
uint64_t pagecount(uint64_t memory_size, uint64_t page_size) {
  // Since we know page size is a power of 2:
...
int main (int argc, char** argv) {
  printf("Page count test: want 1024, got %llu\n", pagecount(4194304, 4096));
  printf("Page count test: want 2048, got %llu\n", pagecount(8388608, 4096));
